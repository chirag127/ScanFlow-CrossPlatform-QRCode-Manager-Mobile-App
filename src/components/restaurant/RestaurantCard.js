    ...
    <Card style={[styles.card, style]} onPress={onPress}>
      ...
      <Card.Content style={styles.content}>
        ...
        <View style={styles.cuisineContainer}>
          ...
          {cuisine.length > 3 && (
            <Text style={styles.moreCuisines}>+{cuisine.length - 3}</Text>
          )}
        </View>
        ...
        <View style={styles.servicesContainer}>
          {provideDelivery && (
            <View style={styles.serviceItem}>
              <Ionicons name="bicycle-outline" size={16} color={theme.colors.text} />
              <Text style={styles.serviceText}>Delivery</Text>
            </View>
          )}
          {provideTakeAway && (
            <View style={styles.serviceItem}>
              <Ionicons name="bag-outline" size={16} color={theme.colors.text} />
